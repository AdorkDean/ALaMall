...
@interface MemberCenterViewController ()<WKUIDelegate, WKNavigationDelegate>
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self configMemberCenterViewControllerViewAndConstraint];
 ...
 */
- (void)configMemberCenterViewControllerViewAndConstraint {
    ...
    NSString * url = @"http://www.blhzsqp.com/index.php/wap/member/indexs";
    if (session.length > 0) {
